...
class Settings(BaseSettings):
    ...
    integration_encryption_key: str | None = Field(default=None, alias='INTEGRATION_ENCRYPTION_KEY')
    public_api_base_url: str = Field(default='http://localhost:8000', alias='PUBLIC_API_BASE_URL')
    public_console_url: str = Field(default='http://localhost:3000', alias='PUBLIC_CONSOLE_URL')
    zendesk_oauth_client_id: str | None = Field(default=None, alias='ZENDESK_OAUTH_CLIENT_ID')
    zendesk_oauth_client_secret: str | None = Field(default=None, alias='ZENDESK_OAUTH_CLIENT_SECRET')
    intercom_oauth_client_id: str | None = Field(default=None, alias='INTERCOM_OAUTH_CLIENT_ID')
    intercom_oauth_client_secret: str | None = Field(default=None, alias='INTERCOM_OAUTH_CLIENT_SECRET')
    slack_oauth_client_id: str | None = Field(default=None, alias='SLACK_OAUTH_CLIENT_ID')
    slack_oauth_client_secret: str | None = Field(default=None, alias='SLACK_OAUTH_CLIENT_SECRET')
    slack_signing_secret: str | None = Field(default=None, alias='SLACK_SIGNING_SECRET')
    integration_allowed_rest_hosts: str = Field(default='', alias='INTEGRATION_ALLOWED_REST_HOSTS')
